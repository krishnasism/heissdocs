          ...
          <ul class="space-y-2 font-medium text-gray-600">
            <li>
              <RouterLink :to="{ name: 'dashboard' }" :class="{
                ...
                'flex items-center p-2 rounded-lg dark:text-white hover:bg-blue-100 dark:hover:bg-gray-700': true
              }">
                <svg fill="currentColor" class="w-6 h-6  dark:text-gray-400 dark:group-hover:text-white"
            ...
            <li>
              <RouterLink :to="{ name: 'search' }" :class="{
                ...
                <svg class="w-6 h-6 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                  viewBox="0 0 20 20">
            ...
            <li>
              <RouterLink :to="{ name: 'ask' }" :class="{
                ...
                <svg class="flex-shrink-0 w-6 h-6  dark:text-gray-400 dark:group-hover:text-white" fill="currentColor"
            ...
            <li>
              <button type="button"
                class="flex items-center w-full p-2 text-base  rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                aria-controls="cloud-operations" data-collapse-toggle="cloud-operations">
                <svg class="flex-shrink-0 w-6 h-6 text-gray-500 dark:text-gray-400 dark:group-hover:text-white"
              ...
              <ul id="cloud-operations" class="hidden py-2 space-y-2">
                <li>
                  <RouterLink :to="{ name: 'cloud-ingest' }" :class="{
                    ...
                    'flex items-center w-full p-2  rounded-lg pl-11 group hover:bg-blue-100 dark:text-white dark:hover:bg-gray-700': true
                  }">
          ...
          <ul class="pt-4 mt-4 space-y-2 font-medium text-gray-600 border-t border-gray-200 dark:border-gray-700">
            <li>
              <RouterLink :to="{ name: 'settings' }" :class="{
                ...
                <svg class="w-6 h-6   dark:text-gray-400 dark:group-hover:text-white" fill="currentColor"
                  viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path clip-rule="evenodd" fill-rule="evenodd"
            ...
            <li>
              <button type="button" @click="logout"
                class="w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-red-100 dark:hover:bg-gray-700">
