          ...
          <ul class="space-y-2 font-medium">
            <li>
              <RouterLink :to="{ name: 'dashboard' }" :class="{
                ...
                <svg fill="currentColor"
                  class="w-6 h-6  dark:text-gray-400 dark:group-hover:text-white"
            ...
            <li>
              <RouterLink :to="{ name: 'ask' }" :class="{
                ...
                <svg
                  class="flex-shrink-0 w-6 h-6  dark:text-gray-400 dark:group-hover:text-white"
            ...
            <li>
              <button type="button"
                class="flex items-center w-full p-2 text-base text-gray-600 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                aria-controls="cloud-operations" data-collapse-toggle="cloud-operations">
                <svg
                  class="flex-shrink-0 w-6 h-6 text-gray-500 dark:text-gray-400 dark:group-hover:text-white"
                  fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path clip-rule="evenodd" fill-rule="evenodd"
