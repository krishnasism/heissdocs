    ...
    <div v-else>
        <div class="relative">
            ...
            <button @click="submitAsk"
                class="bg-gray-200 text-white absolute right-2.5 bottom-2.5 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
