    ...
    <div v-else>
        <div class="relative">
            ...
            <button @click="submitSearch"
                class="bg-gray-200 text-white absolute right-2.5 bottom-2.5 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><svg
                    class="w-4 h-4 text-gray-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex mt-2">
            ...
            <div class="ml-2 text-sm">
                ...
                <p id="chkSearchDocumentDb-text" class="text-xs font-normal text-gray-500 dark:text-gray-300">{{
                    $t('labels.searchDocumentDbHelper') }}</p>
            </div>
        </div>
    </div>
</template>
